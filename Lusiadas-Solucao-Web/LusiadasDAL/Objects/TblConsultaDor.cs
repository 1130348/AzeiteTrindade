...
namespace LusiadasDAL
{
    ...
    {
        [Key, Column(Order=0)] [LDFTableIsVisible(false)]
        ...
        [LDFTableIsVisible(false)] public string DOR { get; set; }
        [LDFTableIsVisible(false)] public string NAUSEA { get; set; }
        [LDFTableIsVisible(false)] public string VOMITOS { get; set; }
        [LDFTableIsVisible(false)] public string INSONIA { get; set; }
        [LDFTableIsVisible(false)] public string CEFALEIA { get; set; }
        [LDFTableIsVisible(false)] public string OUTROS_SINT { get; set; }
        [LDFTableIsVisible(false)] public string ALT_TERAP { get; set; }
        [LDFTableIsVisible(false)] public string OBS { get; set; }
